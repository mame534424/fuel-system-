...
import { createFuelType, createStationFuel, getFuelTypes, getStationStatus, updateStationFuel } from "../controllers/manager.controller";
...
managerRouter.get("/fuel-types",protect,authorize("admin","subAdmin"),getFuelTypes);
